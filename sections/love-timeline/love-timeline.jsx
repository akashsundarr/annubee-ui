    ...
    <div className="max-w-4xl mx-auto relative z-10">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-stone-600 mb-8 max-w-2xl mx-auto">
          20 years of becoming.
        </p>
      </div>

      {/* Responsive Timeline */}
      <div className="relative">
        <div className="absolute left-0 top-0 h-full w-0.5 translate-x-4 bg-stone-300 md:left-1/2 md:-translate-x-1/2"></div>
        <div className="space-y-12">
          {timelineItems.map((item, index) => (
            ...
            >
              <div className="absolute left-0 top-1.5 z-10 flex h-6 w-8 items-center justify-center md:left-1/2 md:-translate-x-1/2">
                <div className="h-4 w-4 rounded-full border-4 border-white bg-stone-400 shadow-sm transition-colors group-hover:bg-rose-500"></div>
              </div>
              <div
                className={`w-full pl-12 md:w-1/2 ${
                  index % 2 === 0
                    ? "md:pl-8"
                    : "md:ml-auto md:pl-0 md:pr-8"
                }`}
              >
                <Card className="transform transition-all duration-300 hover:scale-105 hover:shadow-lg bg-white border border-stone-200 rounded-2xl">
      ...
      <div className="text-center mt-20">
        ...
        <blockquote className="text-lg text-stone-600 italic max-w-3xl mx-auto mb-8 leading-relaxed bg-stone-100 p-6 rounded-2xl border border-stone-200 transform transition-transform hover:scale-105">
          "Every day with you is a new adventure, every moment a new memory to
          treasure. Thank you for being my partner, my best friend, and my
          greatest love. Happy Birthday, my beautiful annuBee!"
        </blockquote>
